...
for col, sampling in enumerate(sampling_list):
    ...
    for row, site in enumerate(site_list):
        ...
        X, Y = load_ROI_data_and_qc(data_dir=data_dir, qc_dir=qc_dir,
                                    site=site)
...
results.to_csv(save_dir+"results_regression_ROI_10_bins_unconf_pooled_data_site_SALD_eNKI_CamCAN_all_sampling_Q.csv")   # noqa
# %%
